...
/**
 * Test fixture for the configuration in mvc-com.config-annotation-driven.xml.
 *
...
public class AnnotationDrivenBeanDefinitionParserTests {
	...
	public void testMessageCodesResolver() {
		loadBeanDefinitions("mvc-com.config-message-codes-resolver.xml");
	...
	public void testPathMatchingConfiguration() {
		loadBeanDefinitions("mvc-com.config-path-matching.xml");
	...
	public void testMessageConverters() {
		loadBeanDefinitions("mvc-com.config-message-converters.xml");
	...
	public void testMessageConvertersWithoutDefaultRegistrations() {
		loadBeanDefinitions("mvc-com.config-message-converters-defaults-off.xml");
	...
	public void testArgumentResolvers() {
		loadBeanDefinitions("mvc-com.config-argument-resolvers.xml");
	...
	public void testReturnValueHandlers() {
		loadBeanDefinitions("mvc-com.config-return-value-handlers.xml");
