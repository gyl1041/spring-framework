...
public class WebMvcConfigurationSupportExtensionTests {
	...
	public void setUp() {
		...
		this.context.registerSingleton("com.controller", TestController.class);
	 ...
	 * that ensures that application com.config classes that use the combo {@code @EnableWebMvc}
