...
/**
 * Trivial com.controller that always returns a pre-configured view and optionally
...
public class ParameterizableViewController extends AbstractController {
	...
	/**
	 * Configure the HTTP status code that this com.controller should set on the
	 * response.
	 ...
	 * fully handled within the com.controller.
	 * @since 4.1
	 */
	 ...
	 * handled within the com.controller and that no view should be used for rendering.
	...
	/**
	 * Whether the request is fully handled within the com.controller.
	 */
