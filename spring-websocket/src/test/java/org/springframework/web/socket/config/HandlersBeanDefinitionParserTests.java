 ...
 * See test configuration files websocket-com.config-handlers-*.xml.
 *
 * @author Brian Clozel
...
public class HandlersBeanDefinitionParserTests {
	...
	public void webSocketHandlers() {
		loadBeanDefinitions("websocket-com.config-handlers.xml");
	...
	public void webSocketHandlersAttributes() {
		loadBeanDefinitions("websocket-com.config-handlers-attributes.xml");
	...
	@Test
	public void sockJs() {
		loadBeanDefinitions("websocket-com.config-handlers-sockjs.xml");
	...
	public void sockJsAttributes() {
		loadBeanDefinitions("websocket-com.config-handlers-sockjs-attributes.xml");
