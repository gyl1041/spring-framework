 ...
 *
 * <p>Such com.service locators permit the decoupling of calling code from
 ...
 * com.service locator via setter or constructor injection, to be able to invoke
 ...
 * mapping} between com.service IDs and bean names can be defined.
 *
 * <p>By way of an example, consider the following com.service locator interface.
 ...
 *}</pre>
 *
 * <p>A sample com.config in an XML-based
 ...
 *            class="org.springframework.beans.factory.com.config.ServiceLocatorFactoryBean">
 ...
 *        MyService com.service = this.myServiceFactory.getService();
 *        // use the com.service object to effect the business logic...
 *    }
 *}</pre>
 *
 * <p>By way of an example that looks up a bean <b>by name</b>, consider
 * the following com.service locator interface. Again, note that this
 ...
 *    public void someBusinessMethod() {
 *        // get a 'fresh', brand new MyService instance
 *        MyService com.service = this.myServiceFactory.getService("specialService");
 *        // use the com.service object to effect the business logic...
 *    }
 *
 *    public void anotherBusinessMethod() {
 *        // get a 'fresh', brand new MyService instance
 *        MyService com.service = this.myServiceFactory.getService("anotherService");
 *        // use the com.service object to effect the business logic...
 *    }
 *}</pre>
 *
...
public class ServiceLocatorFactoryBean implements FactoryBean<Object>, BeanFactoryAware, InitializingBean {
	...
	/**
	 * Set the com.service locator interface to use, which must have one or more methods with
	...
	/**
	 * Set the exception class that the com.service locator should throw if com.service
	...
	/**
	 * Set mappings between com.service ids (passed into the com.service locator)
	 * and bean names (in the bean factory). Service ids that are not defined
	 * here will be treated as bean names as-is.
	 * <p>The empty string as com.service id key defines the mapping for {@code null} and
	 ...
	 * @param serviceMappings mappings between com.service ids and bean names,
	 * with com.service ids as keys as bean names as values
	 */
	...
	public void afterPropertiesSet() {
		...
		// Create com.service locator proxy.
	...
	/**
	 * Determine the constructor to use for the given com.service locator exception
	 * class. Only called in case of a custom com.service locator exception.
	...
	/**
	 * Create a com.service locator exception for the given cause.
	 * Only called in case of a custom com.service locator exception.
	 ...
	 * @param cause the cause of the com.service lookup failure
	 * @return the com.service locator exception to throw
	 * @see #setServiceLocatorExceptionClass
	 */
	...
	/**
	 * Invocation handler that delegates com.service locator calls to the bean factory.
	 */
	private class ServiceLocatorInvocationHandler implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			if (ReflectionUtils.isEqualsMethod(method)) {
				...
				// Use hashCode of com.service locator proxy.
		...
		/**
		 * Check whether a com.service id was passed in.
		 */
		...
		private Class<?> getServiceLocatorMethodReturnType(Method method) throws NoSuchMethodException {
			Assert.state(serviceLocatorInterface != null, "No com.service locator interface specified");
			...
			// Check whether the method is a valid com.service locator.
