...
public class ContextLoader {
	 ...
	 * com.config location for the root context, falling back to the implementation's
	 * default otherwise.
	 ...
	 * ContextLoader after com.config locations have been supplied to the context
