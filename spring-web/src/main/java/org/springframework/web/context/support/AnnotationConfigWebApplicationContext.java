 ...
 *
 * <p>Allows for registering classes one by one (specifying class names as com.config
 * location) as well as for classpath scanning (specifying base packages as com.config location).
 *
		...
		if (configLocations != null) {
			for (String configLocation : configLocations) {
				try {
					...
					if (logger.isTraceEnabled()) {
						logger.trace("Could not load class for com.config location [" + configLocation +
