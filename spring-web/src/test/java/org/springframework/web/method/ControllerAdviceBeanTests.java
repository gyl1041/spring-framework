...
public class ControllerAdviceBeanTests {
	...
	public void assignableTypesSupport() {
		...
		assertApplicable("com.controller implements assignable", bean, ImplementationController.class);
		assertApplicable("com.controller inherits assignable", bean, InheritanceController.class);
	...
	public void multipleMatch() {
		...
		assertApplicable("com.controller implements assignable", bean, ImplementationController.class);
		assertApplicable("com.controller is annotated", bean, AnnotatedController.class);
		assertNotApplicable("should not match", bean, InheritanceController.class);
	}
