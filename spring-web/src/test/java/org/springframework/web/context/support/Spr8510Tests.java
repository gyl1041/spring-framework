 ...
 * regard to com.config location precedence, overriding and defaulting in programmatic
...
public class Spr8510Tests {
	...
	/**
	 * If context com.config locations have been specified neither against the application
