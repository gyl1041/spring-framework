...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
	...
	/**
	 * Specify whether to register annotation com.config post-processors.
	...
	public int scan(String... basePackages) {
		...
		// Register annotation com.config processors, if necessary.
	 ...
	 * <p>This method does <i>not</i> register an annotation com.config processor
