 ...
 * registered automatically when using Java com.config or manually via the
 * {@code <context:annotation-com.config/>} or {@code <context:component-scan/>}
 * element when using XML com.config.
 *
