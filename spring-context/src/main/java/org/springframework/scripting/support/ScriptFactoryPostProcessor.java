 ...
 * references and com.config values to inject into the scripted object itself.
 *
...
public class ScriptFactoryPostProcessor extends InstantiationAwareBeanPostProcessorAdapter
	...
	/**
	 * Create a com.config interface for the given bean definition, defining setter
	 ...
	 * @return the com.config interface
