 ...
 * making it possible to test one com.controller at a time.
 *
 ...
 * customization options are equivalent to using MVC Java com.config except
...
public class StandaloneMockMvcBuilder extends AbstractMockMvcBuilder<StandaloneMockMvcBuilder> {
	 ...
	 * as Spring beans. However since the standalone setup does not load any Spring com.config,
	...
	/**
	 * Provide a conversion com.service with custom formatters and converters.
	...
	/**
	 * Provide custom resolvers for com.controller method arguments.
	 */
	...
	/**
	 * Provide custom handlers for com.controller method return values.
	 */
