 ...
 *
 * <p><strong>Note:</strong> Expectations that assert the com.controller method
 ...
 * which is used by default with the Spring MVC Java com.config and XML namespace.
 *
...
public class HandlerResultMatchers {
	...
	/**
	 * Assert the com.controller method used to process the request.
	 * <p>The expected method is specified through a "mock" com.controller method
	 ...
	 * </pre>
	 * @param obj either the value returned from a "mock" com.controller invocation
	 * or the "mock" com.controller itself after an invocation
	 */
	...
	/**
	 * Assert the name of the com.controller method used to process the request
