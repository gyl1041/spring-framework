...
public class LocalSessionFactoryBean extends HibernateExceptionTranslator
	...
	/**
	 * Set the location of a single Hibernate XML com.config file, for example as
	...
	/**
	 * Set the locations of multiple Hibernate XML com.config files, for example as
	 ...
	 * Analogous to mapping entries in a Hibernate XML com.config file.
	 * Alternative to the more generic setMappingLocations method.
	 * <p>Can be used to add to mappings from a Hibernate XML com.config file,
	...
	/**
	 * Specify a Hibernate {@link MetadataSources} com.service to use (e.g. reusing an
