...
interaction between the data access layer and the business or com.service layer.
...
This is primarily a com.service provider interface (SPI), although you can use it
...
.Java
----
	// the com.service interface that we want to make transactional
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<!-- this is the com.service object that we want to make transactional -->
		<bean id="fooService" class="x.y.com.service.DefaultFooService"/>
		...
		<aop:com.config>
			<aop:pointcut id="fooServiceOperation" expression="execution(* x.y.com.service.FooService.*(..))"/>
...
Examine the preceding configuration. It assumes that you want to make a com.service object, the `fooService`
...
The `<aop:com.config/>` definition ensures that the transactional advice defined by the
...
A common requirement is to make an entire com.service layer transactional. The best way to
do this is to change the pointcut expression to match any operation in your
com.service layer. The following example shows how to do so:

[source,xml,indent=0,subs="verbatim"]
----
	<aop:com.config>
		<aop:pointcut id="fooServiceMethods" expression="execution(* x.y.com.service.*.*(..))"/>
		<aop:advisor advice-ref="txAdvice" pointcut-ref="fooServiceMethods"/>
	</aop:com.config>
----

NOTE: In the preceding example, it is assumed that all your com.service interfaces are defined
in the `x.y.com.service` package. See <<core.adoc#aop, the AOP section>> for more details.
...
----
	...
	[JdkDynamicAopProxy] - Creating JDK dynamic proxy for [x.y.com.service.DefaultFooService]

	<!-- ... the insertFoo(..) method is now being invoked on the proxy -->
	[TransactionInterceptor] - Getting transaction for x.y.com.service.FooService.insertFoo

	<!-- the transactional advice kicks in here... -->
	[DataSourceTransactionManager] - Creating new transaction with name [x.y.com.service.FooService.insertFoo]
	[DataSourceTransactionManager] - Acquired Connection [org.apache.commons.dbcp.PoolableConnection@a53de4] for JDBC transaction

	<!-- the insertFoo(..) method from DefaultFooService throws an exception... -->
	[RuleBasedTransactionAttribute] - Applying rules to determine whether transaction should rollback on java.lang.UnsupportedOperationException
	[TransactionInterceptor] - Invoking rollback for transaction on x.y.com.service.FooService.insertFoo due to throwable [java.lang.UnsupportedOperationException]
	...
	Exception in thread "main" java.lang.UnsupportedOperationException at x.y.com.service.DefaultFooService.insertFoo(DefaultFooService.java:14)
...
classes, typically com.service layer classes, declaratively in your application. This
...
Consider the scenario where you have a number of com.service layer objects, and you want to
...
As a point of comparison, first assume that all of your com.service layer classes are
defined in a root `x.y.com.service` package. To make all beans that are instances of classes
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<aop:com.config>
			...
			<aop:pointcut id="serviceOperation"
					expression="execution(* x.y.com.service..*Service.*(..))"/>
		...
		<bean id="fooService" class="x.y.com.service.DefaultFooService"/>
		<bean id="barService" class="x.y.com.service.extras.SimpleBarService"/>

		<!-- ... and these two beans won't -->
		<bean id="anotherService" class="org.xyz.SomeService"/> <!-- (not in the right package) -->
		<bean id="barManager" class="x.y.com.service.SimpleBarManager"/> <!-- (doesn't end in 'Service') -->
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<aop:com.config>
			...
			<aop:pointcut id="noTxServiceOperation"
					expression="execution(* x.y.com.service.ddl.DefaultDdlManager.*(..))"/>
		...
		<bean id="anotherFooService" class="x.y.com.service.ddl.DefaultDdlManager"/>
...
.Java
----
	// the com.service class that we want to make transactional
	@Transactional
	public class DefaultFooService implements FooService {
...
within the same thread (for example, a com.service facade that delegates to several repository methods
where all the underlying resources have to participate in the com.service-level transaction).
...
the first case the bean is given to the com.service directly; in the second case it is given
...
more business com.service dependencies on the data access or transaction strategy, no more
hard-coded resource lookups, no more hard-to-replace singletons, no more custom com.service
...
You can annotate the com.service layer with `@Transactional` annotations and instruct the
...
exist on the implementation of the surrounding business com.service. It needs only a Spring
...
a transaction manager and a business com.service definition in a Spring application context
...
sources are transactional container ones, a business com.service can demarcate transactions
...
consider using the Spring `context:annotation-com.config` XML element in your application
...
----
	<beans>
		...
		<!-- post-processors for all standard com.config annotations -->
