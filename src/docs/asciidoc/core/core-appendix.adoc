...
{api-spring-framework}/beans/factory/com.config/FieldRetrievingFactoryBean.html[`FieldRetrievingFactoryBean`]
...
{api-spring-framework}/beans/factory/com.config/FieldRetrievingFactoryBean.html#setStaticField(java.lang.String)[`staticField`]
property:
...
----
	...
	<bean id="testBean.age" class="org.springframework.beans.factory.com.config.PropertyPathFactoryBean"/>
----
...
----
	...
	<bean id="theAge"
			class="org.springframework.beans.factory.com.config.PropertyPathFactoryBean">
...
----
	...
	<bean id="jdbcConfiguration" class="org.springframework.beans.factory.com.config.PropertiesFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.config.ListFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.config.MapFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.config.SetFactoryBean">
...
* <<core.adoc#beans-annotation-com.config, `@Autowired`/`@Inject`>> and `@Value`
...
This element is detailed in the section on <<core.adoc#beans-annotation-com.config,
...
----
	...
	import org.springframework.beans.factory.com.config.BeanDefinition;
...
com.service object that (unknown to it) accesses a clustered
...
----
	...
	import org.springframework.beans.factory.com.config.BeanDefinitionHolder;
	import org.springframework.beans.factory.support.AbstractBeanDefinition;
	import org.springframework.beans.factory.support.BeanDefinitionBuilder;
