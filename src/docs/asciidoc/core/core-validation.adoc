...
needs. In the web layer, they can further register com.controller-local local Spring
...
[source,xml,indent=0,subs="verbatim,quotes"]
----
	<bean class="org.springframework.beans.factory.com.config.CustomEditorConfigurer">
...
[[core-convert-Spring-com.config]]
...
<<web.adoc#mvc-com.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
See <<web.adoc#mvc-com.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
<<web.adoc#mvc-com.config-conversion, WebMVC Conversion and Formatting>> or
<<web-reactive.adoc#webflux-com.config-conversion, WebFlux Conversion and Formatting>>.
...
<<web.adoc#mvc-com.config-validation,Spring MVC Validation Configuration>>.
...
See <<web.adoc#mvc-com.config-validation, Validation>> in the Spring MVC chapter.
