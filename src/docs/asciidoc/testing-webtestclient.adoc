...
[[webtestclient-com.controller-com.config]]
=== Bind to Controller
...
The preceding example loads the <<web-reactive.adoc#webflux-com.config, WebFlux Java configuration>>
and registers the given com.controller. The resulting WebFlux application is tested
...
[[webtestclient-context-com.config]]
...
[[webtestclient-server-com.config]]
=== Bind to Server
...
[[webtestclient-client-com.config]]
=== Client Builder
