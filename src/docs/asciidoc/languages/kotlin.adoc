...
https://docs.spring.io/spring-boot/docs/current/reference/html/boot-features-external-com.config.html#boot-features-external-com.config-typesafe-configuration-properties[`@ConfigurationProperties`]
