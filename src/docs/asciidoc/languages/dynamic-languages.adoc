...
the meaty business logic of an application being contained in the domain and com.service
...
----
	...
	import org.springframework.showcase.fortune.com.service.FortuneService
